function generateConditionalArticles() {
    ...
    if (maladies.includes('Problèmes de stress/anxiété')) {
        htmlContent += `
            <div class="recommendation-item">
                ...
                <a href="https://www.decathlon.fr/p/mp/nutrietco/rhodiola-rosea-bio-anti-stress-fatigue-anxiete-et-relaxation-60-gelules/_/R-p-69a3d95d-92c3-42b9-be6f-658e7b912194?mc=69a3d95d-92c3-42b9-be6f-658e7b912194_g78&fl=Neutre" target="_blank">Voir l'article chez Decathlon</a>
            </div>
        `;
    ...
    if (maladies.includes("Problèmes d'articulation")) {
        htmlContent += `
            <div class="recommendation-item">
                ...
                <a href="https://www.decathlon.fr/p/kit-de-tapes-kinesiologie-predecoupes-articulations-tendons-et-muscles/_/R-p-197323?mc=8781238" target="_blank">Voir l'article chez Decathlon</a>
            </div>
        `;
        santeArticlesFound = true;
    }
    ...
    if (maladies.includes('Problèmes de sommeil')) {
        htmlContent += `
            <div class="recommendation-item">
                ...
                <a href="https://www.decathlon.fr/p/mp/nutrietco/melatonine-1-9mg-endormissement-sommeil-et-jetlag-format-spray-20ml/_/R-p-12d5d783-08a2-487e-9c1e-e51704141eb0?mc=12d5d783-08a2-487e-9c1e-e51704141eb0_g116&fl=Vanille" target="_blank">Voir l'article chez Decathlon</a>
            </div>
        `;
        santeArticlesFound = true;
    }
    ...
    // ==========================================================
    // 2. LOGIQUE DES ARTICLES LIÉS AU POSTE DE TRAVAIL
    // ==========================================================
    ...
    if (envTravail === 'Physique') {
        htmlContent += `
            <div class="recommendation-item">
                ...
                <a href="https://www.decathlon.fr/p/mp/salomon/chaussures-d-exterieur-salomon-xa-pro-3d-v9-gtx-adulte/_/R-p-44022a55-f149-48a5-bf5b-79de0f909700?mc=44022a55-f149-48a5-bf5b-79de0f909700_c1c1" target="_blank">Voir l'article chez Decathlon</a>
            </div>
        `;
    ...
    if (envTravail === 'Bureau') {
        htmlContent += `
            <div class="recommendation-item">
                ...
                <a href="https://www.decathlon.fr/p/ceinture-lombaire-adulte-correcteur-de-posture-noir/_/R-p-X8811950?mc=8811950" target="_blank">Voir l'article chez Decathlon</a>
            </div>
        `;
        travailArticlesFound = true;
    }
    ...
    if (posture === 'Assis') { // Note: La posture Assis s'applique souvent au Bureau, mais peut être un complément.
        htmlContent += `
            <div class="recommendation-item">
                ...
                <a href="https://www.decathlon.fr/p/gym-ball-taille-1-resistant-55-cm-rose/_/R-p-328533?mc=8603633&c=bleu" target="_blank">Voir l'article chez Decathlon</a>
            </div>
        `;
        travailArticlesFound = true;
    }
    ...
    if (posture === 'Debout') {
        htmlContent += `
            <div class="recommendation-item">
                ...
                <a href="https://www.decathlon.fr/p/mp/innovagoods/matelas-de-massage-par-vibration-innovagoods/_/R-p-e7824053-1b37-44c7-a1cd-7ad85170a3e1?mc=e7824053-1b37-44c7-a1cd-7ad85170a3e1_c255" target="_blank">Voir l'article chez Decathlon</a>
            </div>
        `;
        travailArticlesFound = true;
    }
    ...
    if (chargesLourdes === 'Oui') {
        htmlContent += `
            <div class="recommendation-item highlight">
                ...
                <a href="https://www.decathlon.fr/p/ceinture-de-maintien-lombaire-avec-straps-reglables-niveau-4/_/R-p-364449?mc=8941379&utm_source=chatgpt.com" target="_blank">Voir l'article chez Decathlon</a>
            </div>
        `;
        travailArticlesFound = true;
    }
